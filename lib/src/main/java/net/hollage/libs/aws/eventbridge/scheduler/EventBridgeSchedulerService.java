...
public class EventBridgeSchedulerService {
     ...
     * @throws SchedulerException スケジュール作成中にエラーが発生した場合
     */
     ...
     * @throws SchedulerException スケジュール作成時にエラーが発生した場合
     */
    public void createSchedule(String name, String scheduleExpression, String lambdaArn, Map<String, Object> payload, String roleArn) {
        CreateScheduleRequest request = CreateScheduleRequest.builder()
                .name(name)
                .scheduleExpression(scheduleExpression)
